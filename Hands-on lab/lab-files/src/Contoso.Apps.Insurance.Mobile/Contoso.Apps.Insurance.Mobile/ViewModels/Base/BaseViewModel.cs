...
namespace CIMobile.ViewModels.Base
{
    public class BaseViewModel : INotifyPropertyChanged
    {
        ...
        FileImageSource appIcon = null;
        /// <summary>
        /// Gets or sets the overall application "Icon" of the viewmodel
        /// </summary>
        public const string AppIconPropertyName = "AppIcon";

        public FileImageSource AppIcon
        {
            get { return icon; }
            set { SetProperty(ref appIcon, value, AppIconPropertyName); }
        }
