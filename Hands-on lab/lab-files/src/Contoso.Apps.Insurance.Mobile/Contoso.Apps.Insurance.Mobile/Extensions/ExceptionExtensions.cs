...
namespace CIMobile.Extensions
{
    public static class ExceptionExtensions
    {
        ...
        {
            return $"EXCEPTION: {callingClass.GetType().FullName}: {ex.Message}  |  {ex.StackTrace}";
        }
        ...
        {
            return $"EXCEPTION: {callingClassType.FullName}: {ex.Message}  |  {ex.StackTrace}";
        }
