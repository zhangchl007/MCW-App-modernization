...
namespace CIMobile.Statics
{
    public static class Palette
    {
        ...
        /// </summary>
        public static readonly Color _001 = Color.FromHex("00acda");

        /// <summary>
        /// Secondary color. Device status bar on Android.
        /// </summary>
        public static readonly Color _002 = Color.FromHex("002157");

        /// <summary>
        /// Ternary color. Accent color on Android.
        /// </summary>
        public static readonly Color _003 = Color.FromHex("61c1da");
